    ...
    <main id="profile">
            ...
            <div class="profile__column">
                ...
                <ul class="profile__stats">
                    <li class="profile__stat">
                        <span class="stat__number"><?php echo $jmlFoto ?></span> posts
                    </li>
                    <li class="profile__stat">
                ...
                <p class="profile__bio">
                    ...
                    <a href="<?php $_SESSION['website'] ?>"><?php echo $_SESSION['website'];?></a>
                    <!--<?php 
        ...
        ?>
            <div class="profile__photo">
                <img  width="500px" heigth="500px" src="<?php echo $foto[$i][1]; ?>" />
